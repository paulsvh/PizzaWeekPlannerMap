...
import { RouteDetailStopList } from '@/app/routes/[routeId]/RouteDetailStopList';
      ...
      <article className="relative mx-auto max-w-3xl px-5 pt-10 pb-16 sm:pt-14">
        ...
        >
          ...
          <RouteDetailStopList
            mapsApiKey={process.env.NEXT_PUBLIC_GOOGLE_MAPS_BROWSER_KEY ?? ''}
            stops={stops}
            legDistancesMeters={route.legDistancesMeters}
            legDurationsSeconds={route.legDurationsSeconds}
